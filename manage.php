...
<html>
    ...
    <body>
        ...
        <?php
        if($heatsEnabled == true) {
            include('manage_heats.php');
        }
        ...
        ?>
            ...
            <?php
            if($heatsEnabled == true) {
                echo '<div style="display: inline-block; width: 50%; background-color: #DFDFDF;">';
                echo '<h3>Second Feature Entry List</h3>';
            ...
            if(true) {
                ...
                for ($i = 0; $i < count($fc); $i++) {
                    if(true) {
			      	...
			      	$data = str_replace("%car%", substr($line, 6), $data);
			    }
                        }
                        $color = "#BEBEBE";
